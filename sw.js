/**
 * SplitGasto 2026 - Service Worker v2.0 PLATINUM
 * ESTRATEGIA:
 *   - HTML pages: Network-first (siempre obtiene la última versión, fallback a caché)
 *   - Assets estáticos (JS/CSS/icons/fonts): Cache-first
 *   - Sin interceptar navegación HTML para no bloquear rutas
 */

const CACHE_NAME = 'splitgasto-v3-2026';
const CACHE_ASSETS = [
  '/engine/router.js',
  '/engine/global.css',
  '/favicon.svg',
